...
def mock_admin2_data():
    ...
    admin1 = Admin1(id=10, name="Antioquia", country=country, ext_id="05")
    return [
        Admin2(id=100, name="Medellín", admin_1=admin1, ext_id="05001"),
        Admin2(id=101, name="Envigado", admin_1=admin1, ext_id="05266")
    ]
