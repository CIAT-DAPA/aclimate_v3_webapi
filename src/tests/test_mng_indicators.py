...
def mock_mng_indicator_data():
    class Indicator:
        def __init__(self, id, name, short_name, unit, type_, description, enable, registered_at, updated_at):
            self.id = id
            self.name = name
    ...
    return [
        Indicator(1, "consecutive_rainy_days", "crd", "days", "CLIMATE", "desc", True, "2024-01-01T00:00:00", "2024-01-02T00:00:00"),
        Indicator(2, "precipitation", "prec", "mm", "CLIMATE", "desc", True, "2024-01-01T00:00:00", "2024-01-02T00:00:00")
    ]
